...
test.describe('ACCOUNT - Account', async () => {
    ...
    test('@ACC_002: Create account with subscriber  permission', async ({ page }) => {
        ...
        await expect(page.locator('//div[@id="adminmenuwrap"]//div[@class="wp-menu-name" and text()="Posts"]')).toBeHidden();
        await expect(page.locator('//div[@id="adminmenuwrap"]//div[text()="Media"]')).toBeHidden();
        await expect(page.locator('//div[@id="adminmenuwrap"]//div[text()="Pages"]')).toBeHidden();
        await expect(page.locator('//div[@id="adminmenuwrap"]//div[text()="Comments "]')).toBeHidden();
        await expect(page.locator('//div[@id="adminmenuwrap"]//div[text()="Tools"]')).toBeHidden();
        await expect(page.locator('//div[@id="adminmenuwrap"]//div[text()="Plugins "]')).toBeHidden();
        await expect(page.locator('//div[@id="adminmenuwrap"]//div[text()="Appearance"]')).toBeHidden();
        await expect(page.locator('//div[@id="adminmenuwrap"]//div[text()="Users"]')).toBeHidden();
